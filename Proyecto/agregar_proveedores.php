...
<div class="container">
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        try {
            $stmt = $conexion->prepare("INSERT INTO proveedor (nombre, direccion, telefono, email) VALUES (?, ?, ?, ?)");
    ...
    <br>
    <a href="ver_proveedores.php" class="btn btn-secondary">Volver a Proveedores</a>
</div>
